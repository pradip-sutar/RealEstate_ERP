...
urlpatterns = [
    ...
    path('project_segment_handler/', views.project_segment_handler, name='project_segment_handler'),
    path('project_varient_handler/', views.project_varient_handler, name='project_varient_handler'),
